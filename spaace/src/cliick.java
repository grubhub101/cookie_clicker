...
public class cliick extends JFrame {
    double cookies = 0;
    ...
    public class CookiePanel extends JPanel implements ActionListener {
        ...
        public CookiePanel(cliick parent) {
            clicker = parent;
    ...
    public class ProducerPanel extends JPanel {
        ...
        public ProducerPanel(cliick clicker) {
    ...
    public class ShopItem {
        ...
        public ShopItem(String nm, double pr, double c, final cliick clicker) {
            name = nm;
            price = pr;
            cps = c;
    ...
    public class ShopPanel extends JPanel {
        final cliick clicker;
        public ShopPanel(cliick parent) {
            clicker = parent;
